...
<p align="left"> Olá! Meu nome é <strong>Thaissa</strong>, tenho 26 anos e sou <strong>Analista de Qualidade de Software I</strong> na Autoglass.
...
<p align="left"> 🛠️ Ferramentas: <strong>Cypress</strong>, <strong>Jenkins/CI-CD</strong>, <strong>VS Code</strong>. </p>

<p align="left"> 📚 Certificações: <strong>Google IT Support</strong>,cursando <strong>Microsoft Full Stack Developer</strong>. </p>

<p align="left"> 🤝 Atuação voluntária: <strong>Membro da Liga Feminina de TI (UVV)</strong>, fomentando a presença feminina no setor tecnológico. </p>
